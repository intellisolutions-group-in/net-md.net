...
const faqs = [
  ...
  { q: "How do you ensure data security and compliance?", a: "Security is built into every layer of our process. We follow industry best practices including encryption at rest and in transit, OWASP standards, and can support GDPR, HIPAA, and SOC 2 compliance requirements." },
        ...
        <div className="container-custom">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
            {[
              ...
              { icon: Users, title: "Dedicated Team", desc: "A passionate team of certified experts committed to your success from kickoff to deployment." },

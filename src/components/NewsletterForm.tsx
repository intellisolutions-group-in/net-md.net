...
export const NewsletterForm = () => {
  ...
  return (
    ...
    >
      ...
      />
      <button className="bg-primary text-white px-8 py-5 rounded-2xl font-black text-sm uppercase tracking-widest hover:shadow-[0_20px_40px_rgba(246,161,141,0.3)] transition-all">
